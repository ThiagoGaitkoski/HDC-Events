...
class EventController extends Controller
{
    ...
    public function joinEvent($id){
        ...
        $user->eventsAsParticipant()->attach($id); //Not a error
    ...
    public function leaveEvent($id){
        ...
        $user->eventsAsParticipant()->detach($id); //Not a error

        $event = Event::findOrFail($id);

        return redirect('/dashboard')->with('msg', 'Sua presença está desvinculada do evento: ' . $event->title);
    }
}